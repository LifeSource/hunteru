(function (seedData) {
	...
	seedData.hunters = [
...

		{
			...
			gender: "Male",
			age: 34,
			occupation: ["Archoelogical Hunter"],
			nen: ["Unknown"],
			nenData: [100, 80, 65, 90, 70, 85],
...

		{
			...
			nen: ["Manipulation"],
			nenData: [10, 20, 15, 10, 70, 15],
			abilities: [],
			bio: "Milluki is short-tempered, selfish and rather immature for his age, still referring to his mother and father as mama and papa, and Illumi as Illu-nii or 'Big brother Illumi'. He often fights with his younger brother, Killua. "
		},
...

		{
			...
			gender: "Male",
			age: 34,
			occupation: ["Hunter Association President"],
			nen: ["Unknown"],
			nenData: [80, 50, 66, 100, 70, 85],
			abilities: ["100-Type GuanYin Bodhisattva", "First Hand", "Third Hand", "Ninety-Ninth Hand", "Zero Hand"],
			bio: "Ging is the only grandson of Gon's great-grandmother. He and Mito are cousins. Ging left Whale Island to take the 267th Hunter Examination not long before turning 12. Right after his departure, Mito's parents and his father died consecutively. He was the only participant to pass the 267th Hunter Exam."
		}, {
			name: {
				first: "Hisoka",
...

		{
			...
			gender: "Male",
			age: 26,
			occupation: ["Phantom Troupe Leader"],
			nen: ["Specilization"],
			nenData: [55, 30, 15, 100, 10, 15],
...

		{
			...
			nen: ["Transmutation"],
			nenData: [60, 80, 15, 10, 30, 15],
			abilities: ["Magical Spa Services", "Cookie-Chan", "Piano Mssage"],
			bio: "Not much is revealed about Bisky's past. By her own admission, she started to learn Nen at the age of 17. She also studied Shingen-ryū kung fu and later became Wing's master — the man who introduced Nen to Killua and Gon. She also served as an examiner in an unknown Hunter Exam."
		...
		},
		{
			...
			gender: "Male",
			age: 28,
			occupation: ["Shingen-Ryu Master"],
			nen: ["Enhancement"],
			nenData: [80, 20, 15, 10, 10, 15],
			abilities: ["Magical Spa Services", "Cookie-Chan", "Piano Mssage"],
			...
			gender: "Male",
			age: 9,
			occupation: ["Trainee", "Shingen-Ryu Master"],
			nen: ["Manipulation"],
			nenData: [60, 20, 15, 10, 90, 15],
			abilities: ["Unknown"],
